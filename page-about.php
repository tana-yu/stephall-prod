...
?>
 ...
 <main role="main"> 
    ...
    <section class="leading">
        ...
        <p>
            大阪・中津にあるライブハウス「StepHALL」は、2018年にミノヤホールの意志を引き継ぎオープンしました<br>
            バンド、アコースティック、DJ、アイドル、演劇、トークなどオールジャンル対応可能。<br>
            温かくアットホームな雰囲気の中で、出演者も観客も自然と笑顔になれる場所<br>
            “やりたい”を形にできるステージとして、アーティストの“次の一歩”を応援します！
        </p>
        <dl class="info">
            <div>
                <dt>収容人数</dt>
        ...
        <dl class="info">
            <div>
                ...
                <dd>
                    ...
                    <span class="fee-example">
                        メインスピーカー 1対向(パワードスピーカー)<br>
                        モニタースピーカー 2台(パワードスピーカー)<br>
                        有線マイク ５本<br>
                        ワイヤレスマイク 2本<br>
                        CDデッキ 1台<br>
                        音響・アシスタント人員<br>
                        機材運搬費(大阪市内)<small>※1</small><br><br>

                        <small>
                            ※1.大阪市外、府外については別途距離に大阪市からの距離に応じて追加運搬費用を頂いております。
                        </small>
                        <br><br>
                    </span class="example">
